...
public class SparkAIManager extends WebSocketListener {
    // 地址与鉴权信息  https://spark-api.xf-yun.com/v1.1/chat   1.5 地址  domain参数为general
    // 地址与鉴权信息  https://spark-api.xf-yun.com/v2.1/chat   2.0 地址  domain参数为generalv2
    // 目前已经有三种版本 请根据您的模型替换 hostURL 讯飞星火官网地址：https://xinghuo.xfyun.cn/sparkapi
    public static final String hostUrl = "https://spark-api.xf-yun.com/v3.5/chat";
    // 替换成你自己的 appid 图书管理系统 1.1 版本 1.2 版本请找 AiIntelligentServiceImpl 替换代码块即可
    public static final String appid = "4868e724";
    // 替换成你自己的 apiSecret 图书管理系统 1.1 版本
    public static final String apiSecret = "YjVlNmI1Y2IxNjJiZmMyNzdiYjBhZDRm";
    // 替换成你自己的 apiKey 图书管理系统 1.1 版本
    public static final String apiKey = "963b7be2ea6fa93481f209ab9e337d4e";
