...
//                System.out.println("解析数据为:" + bookData.toString());
        ...
        return R.success(null,"Excel 批量添加图书成功");
    }
    ...
    public R<Map<String, Object>> getDashboardStatistics() {
        ...
        try {
            // 查询图书总数
            LambdaQueryWrapper<Books> bookCountWrapper = new LambdaQueryWrapper<>();
            Long totalBooks = booksMapper.selectCount(bookCountWrapper);
            statistics.put("totalBooks", totalBooks != null ? totalBooks : 0);
            
            // 查询读者数量
            LambdaQueryWrapper<Users> userCountWrapper = new LambdaQueryWrapper<>();
            Long totalUsers = usersMapper.selectCount(userCountWrapper);
            ...
            Long todayBorrow = booksBorrowMapper.selectCount(borrowCountWrapper);
            ...
            Long violations = violationMapper.selectCount(violationCountWrapper);
